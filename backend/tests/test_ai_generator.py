...
class TestAIGenerator:
    ...
    def test_generate_direct_response_no_tools(
        self, ai_generator, mock_anthropic_client, anthropic_direct_response
    ):
        ...
        assert (
            response
            == "MCP stands for Model Context Protocol, a standard for connecting AI models to data sources."
        )
    ...
    def test_generate_response_with_tool_use(
        ...
        assert (
            len(messages) == 3
        )  # Original query, assistant tool_use, user tool_result
    ...
    def test_tool_execution_without_tool_manager_returns_direct_response(
        self, ai_generator, mock_anthropic_client, anthropic_tool_use_response
    ):
    ...
    def test_generate_response_with_empty_query(
        self, ai_generator, mock_anthropic_client, anthropic_direct_response
    ):
        ...
        response = ai_generator.generate_response(
            query="", tools=None, tool_manager=None
        )
