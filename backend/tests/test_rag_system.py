...
class TestRAGSystem:
    ...
    def test_query_without_session(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "MCP is a protocol for AI."
    ...
    def test_query_with_session(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "Here's more information about MCP."
        mock_rag_system.tool_manager.get_last_sources.return_value = []
    ...
    def test_query_returns_empty_sources_when_no_tool_used(self, mock_rag_system):
        ...
        mock_rag_system.session_manager.get_conversation_history.return_value = None
        mock_rag_system.ai_generator.generate_response.return_value = "General knowledge answer"
        mock_rag_system.tool_manager.get_last_sources.return_value = []
    ...
    def test_query_handles_tool_manager_errors(self, mock_rag_system):
        ...
        mock_rag_system.session_manager.get_conversation_history.return_value = None
        mock_rag_system.ai_generator.generate_response.return_value = "Response"
        mock_rag_system.tool_manager.get_last_sources.side_effect = Exception("Tool error")
...
class TestRAGSystemEndToEnd:
    ...
    def test_end_to_end_content_query(self, integrated_rag_system, mock_search_results):
        ...
        integrated_rag_system.vector_store.get_lesson_link.return_value = "https://example.com/lesson1"

        # Setup: AI generator returns response
        integrated_rag_system.ai_generator.generate_response.return_value = "MCP is a protocol for AI models."
    ...
    def test_tool_manager_integration_with_search_tool(self, integrated_rag_system, mock_search_results):
