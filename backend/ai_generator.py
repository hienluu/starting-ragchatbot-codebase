...
"""
    ...
    def _handle_tool_execution(self, initial_response, base_params: Dict[str, Any], tool_manager):
        ...
        for round_num in range(config.MAX_TOOL_ROUNDS):
            ...
            next_params = {
                **self.base_params,
                ...
                "tools": base_params.get("tools"),  # Include tools (was excluded before)
        ...
        if current_response.stop_reason == "tool_use":
            ...
            text_blocks = [block.text for block in current_response.content if getattr(block, 'type', None) == 'text']
